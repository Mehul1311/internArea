...
export default function Login() {
  ...
  const handleLoginSuccess = (userData: any) => {
    const userToStore = {
      ...
      photo: userData.photo || "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop"
    };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-md mx-auto px-4 py-16">
        <div className="bg-white rounded-3xl border border-gray-200 p-8 shadow-xl">
          ...
          <div className="bg-gray-50 p-3 rounded-2xl border border-gray-200 mb-6 flex items-center justify-between text-xs">
            <div className="flex items-center gap-2 font-semibold text-gray-700">
              <ShieldAlert size={16} className="text-amber-500" />
              <span>Mobile Time Rule (10 AM - 1 PM IST)</span>
            </div>
          </div>
